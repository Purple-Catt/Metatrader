...
class WindowGenerator:
    """Create a Window object that stores three-dimentional arrays to be used in the fitting process.
    Directly implemented from TensorFlow website, for further information visit:\n
